...
dataset = S3ImageDatasets(bucket_name=AWS_BUCKET_NAME,version='split_1',usage='train')

train_loader = DataLoader(dataset, batch_size=16, shuffle=True)

dataset = S3ImageDatasets(bucket_name=AWS_BUCKET_NAME,version='split_1',usage='test')

test_loader = DataLoader(dataset, batch_size=16, shuffle=True)


from src.models.Efficientnets import Efficientnets
model = Efficientnets(0)
#model = ResNet18()
